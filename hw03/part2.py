def print_personal(first_name, second_name, birthday, city, email, phone):
    return f"Имя: {first_name}, фамилия: {second_name}, год рождения: {birthday}, город проживания: {city}, email: {email}, телефон: {phone}"
...
print(print_personal(first_name=p_fname, second_name=p_sname, birthday=p_birthday, city=p_city, email=p_email, phone=p_phone))
